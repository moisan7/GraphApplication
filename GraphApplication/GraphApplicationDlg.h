...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	void SetViewDistances(bool v) { m_ViewDistances = v; }
	...
	afx_msg void OnBnClickedButtonKruskalLabel();
	afx_msg void OnBnClickedButtonKruskalTree();
	...
	afx_msg void OnBnClickedButtonDynamicProgramming1();
	afx_msg void OnBnClickedButtonBranchBound4();
	afx_msg void OnFilesLoadGraphVisits();
	afx_msg void OnFilesSaveGraphVisits();
	afx_msg void OnBnClickedButtonDynamicProgramming2();
};
